...
export default function Search(propSearch) {
  ...
  return (
    <div className='flex flex-col md:flex-row'>
      ...
      <div className='flex-1'>
        <h1 className='text-3xl font-semibold border-b p-3 text-primary mt-5'>
          Results:
        </h1>
        <div className='p-7 flex flex-wrap gap-4'>
          {!loading && listings.length === 0 && (
            <p className='text-xl text-primary'>No listing found!</p>
          )}
          {loading && (
            <p className='text-xl text-primary text-center w-full'>
              Loading...
            </p>
          )}
